# Code Enhancement: camunda-mcp

> Automated code enhancement review for camunda-mcp. Covers 17 analysis domains.
...
- **FR-021**: Undocumented env vars: LLM_API_KEY, LLM_BASE_URL, MCP_URL, MODEL_ID
